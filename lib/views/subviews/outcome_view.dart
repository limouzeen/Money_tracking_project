...
class _OutcomeViewState extends State<OutcomeView> {
  ...
  final TextEditingController outcomedetailController = TextEditingController(text: '');
  final TextEditingController outcomeamountController = TextEditingController(text: '');
  final TextEditingController outcomedateController = TextEditingController(text: '');
...
Future<void> showCompleteDialog(BuildContext context, String msg) {
          ...
          Column(
            ...
            children: [
              ...
              child: buildTextField(
                controller: outcomedetailController,
                hintText: 'DETAIL',
            ...
            Padding(
              ...
              child: buildTextField(
                ...
                onTap: () {
                  _openCalendar(true, outcomedateController); // Pass the controller for updating
                },
              ),
            ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if(outcomeamountController.text.trim() == '' || outcomedetailController.text.trim() == '' || outcomedateController.text.trim() == '') {
                            showWarningDialog(context, 'กรุณาป้อนข้อมูลให้ครบถ้วน');
                          } else{
                            String moneyType = '2';

                            Money money = Money(
                              moneyInOut: outcomeamountController.text.trim(),
                              moneyDetail: outcomedetailController.text.trim(),
                              moneyDate: outcomedateController.text.trim(),
                              moneyType: moneyType,
                              userId: widget.user!.userId,
  ...
  CallAPI.callinsertIncomeAPI(money).then((value) {
    if (value.message == '1') {
      ...
      setState(() {
        outcomeamountController.clear();
        outcomedetailController.clear();
